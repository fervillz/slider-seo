function createDivContainer($) {
    ...
    var Element =
		...
		+ 			'<input type="text" class="widefat" id="slider-img-title" value="">'
		...
		+ 				'</div>' 
		+ 			'</small>'
		+ 			'<input type="text" class="widefat" id="slider-img-alt" value="">'
		...
		+ 				'</div>' 
		+ 			'</small>'
		+			'<input type="hidden" name="" id="slider-img-src">'
		+ 			'<input type="hidden" name="" id="slider-img-srcT">'
		+ 			'</div>'
		...
		+ 				'</div>'
		+ 			'</small>'
		+ 			'<input class="widefat" type="text" id="slider-img-url" value="">'
