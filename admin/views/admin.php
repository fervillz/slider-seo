			...
			<div class="tab-content">
				<div class="tab-item tab-seo">
					...
					<small> <?php _e( 'Slider Image Title Text', 'slider-seo') ?>
						<div class="tooltip gray-green dashicons dashicons-editor-help">
							<div class="tooltiptext top large"><?php esc_html_e( '<b>Use keyword(s) in title. Preferably using english words.</b> <br><br>ie: istead of "iStock_00044xSmall.jpg" which doesn\'t add much information about an image, use "image-optimization.jpg".', 'slider-seo'); ?>
							</div>
						</div> 
					</small>
					...
					<small> <?php _e( 'Slider Image Alt Text', 'slider-seo'); ?> 
						<div class="tooltip gray-green dashicons dashicons-editor-help">
							<div class="tooltiptext top large"><?php esc_html_e('<b>Create descriptive alt text</b> <br><br>
				...
				<div class="tab-item tab-others">
					...
					<small> Slider Image Short Caption
						<div class="tooltip gray-green dashicons dashicons-editor-help">
							<div class="tooltiptext top large"><?php esc_html_e( '<b>Short descriptive content about the image</b> <br><br>Image captions are important because they are one of the most well-read pieces of content on your entire site.', 'slider-seo'); ?>
							</div>
						</div>
					</small>
